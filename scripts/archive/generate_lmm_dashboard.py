...
def generate_dashboard():
    ...
    <head>
        ...
        <style>
            ...
            .panel { background: var(--panel); border-radius: 12px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.3); margin-bottom: 20px; }
            .summary { background: #1e293b; padding: 20px; border-radius: 12px; border-left: 5px solid #10b981; margin-bottom:20px; }
            .explanation { background: #1e293b; padding: 20px; border-radius: 12px; border-left: 5px solid #f59e0b; margin-bottom:20px; }
        </style>
    </head>
    <body>
        <div class="container">
